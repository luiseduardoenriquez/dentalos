...
Creates:
  - Plans: free, starter, pro, clinica, enterprise
...
PLANS: list[dict] = [
    ...
    },
    {
        "name": "Pro",
        "slug": "pro",
        "description": "Plan profesional con todas las herramientas clínicas.",
        "max_patients": -1,
        "max_doctors": -1,
        "max_users": -1,
        ...
        "pricing_model": "per_doctor",
        "included_doctors": 1,
        "additional_doctor_price_cents": 3900,
        "is_active": True,
        "sort_order": 2,
    },
    {
        "name": "Clínica",
        "slug": "clinica",
        "description": "Plan para clínicas con múltiples sedes y doctores.",
        "max_patients": -1,
        "max_doctors": -1,
        "max_users": -1,
        ...
        "included_doctors": 3,
        "additional_doctor_price_cents": 1500,
        "is_active": True,
        "sort_order": 3,
    },
    {
