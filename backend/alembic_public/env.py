...
from app.models.base import PublicBase

# Import all public models so metadata is populated
...
def include_object(object, name, type_, reflected, compare_to):  # noqa: A002
    ...
    if type_ == "table":
        return getattr(object, "schema", None) == "public" or getattr(object, "schema", None) is None
    return True
